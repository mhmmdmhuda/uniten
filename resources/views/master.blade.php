...
<html lang="en">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="nav navbar-nav">
            <li class="active"><a href="/admin">Post</a></li>
            <li class="active"><a href="/categori">Categories</a></li>
            <li class="active"><a href="/appointment">Appointment</a></li>
            <li class="active"><a href="/administrator">Admin</a></li>
  ...
  <!-- container -->
    ...
    <script src="{{ asset('/dist/js/sb-admin-2.js')}}" charset="utf-8"></script>
    <script src="{{ asset('/metisMenu/metisMenu.min.js')}}" charset="utf-8"></script>
